...
function hideWarning1() {
      $("#inputCode").removeClass("warring");
      $("#inputName").removeClass("warring");
      $("#inputTel").removeClass("warring");
      $("#inputPassword").removeClass("warring");
      $(".warningBox").hide();
      $("#warmLabel").html("");
}
...
//邀请码注册
function inviteCode(data,callBack){
    $.post("/system/invite",data,function(backData){
        callBack(backData);
    }).fail(function(){
        callBack(500);
    });
