...
public class SaasUser implements Serializable {
    private static final long serialVersionUID = -9063655415125166795L;
    /**
     * 用户Id
     */
    @Id
    ...
    /**
     * 获取人员状态：1.已激活、2.未激活、3.已禁用、4.未分配部门、89.离职、
     *
     * @return status - 人员状态：1.已激活、2.未激活、3.已禁用、4.未分配部门、89.离职、
     */
    ...
    /**
     * 设置人员状态：1.已激活、2.未激活、3.已禁用、4.未分配部门、89.离职、
     *
     * @param status 人员状态：1.已激活、2.未激活、3.已禁用、4.未分配部门、89.离职、
     */
