...
@Table(name = "`platform_program_components`")
public class PlatformProgramComponents implements Serializable {
    @Id
    @Column(name = "`id`")
    private String id;
     ...
     * 获取组件code 目前是4位数字编码
     *
     * @return c_code - 组件code 目前是4位数字编码
     */
