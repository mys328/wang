...
@Table(name = "`info_programe_label`")
public class InfoProgrameLabel implements Serializable {
    /**
     * 主键
     */
    @Id
    ...
    /**
     * 获取标签状态:发布状态:1;内测状态:2
     *
     * @return label_status - 标签状态:发布状态:1;内测状态:2
     */
    ...
    /**
     * 设置标签状态:发布状态:1;内测状态:2
     *
     * @param labelStatus 标签状态:发布状态:1;内测状态:2
     */
